...
entity sp_axi4_master_v1_0_M00_AXI is
	generic (
...
end sp_axi4_master_v1_0_M00_AXI;

architecture implementation of sp_axi4_master_v1_0_M00_AXI is
...
--	 signal mst_exec_state  : state ;
	...
	--write strobes
	signal write_strobes : std_logic_vector(C_M_AXI_DATA_WIDTH/8-1 downto 0);
...
--	signal last_read	: std_logic;
	...
	--smallpond write is over (no error)
	signal write_over : std_logic;
	--smallpond read is over (no error)
	signal read_over :std_logic;
	--smallpond write error
	signal write_error : std_logic;
	--smallpond read error
...
--	M_AXI_ARADDR	<= std_logic_vector(unsigned(C_M_TARGET_SLAVE_BASE_ADDR) + unsigned(axi_araddr));
	...
	-- VALID data and the slave acknoledges it is alssp_data <=o READY. While the master
