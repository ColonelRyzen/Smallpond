...
{%Numbers above the instruction layout. DO NOT CHANGE
    ...
    \paragraph{Usage}
    \begin{flushleft}
    % Short description of the use of the instruction
    % Ex: The LSR instruction is used to execute a logical right shift on a value and store the result.
    #4\\
    \end{flushleft}
    \paragraph{Example}
    \begin{flushleft}
...
%BEGINNING OF ASR INSTRUCTION  
    ...
    % RD  \hspace{3.6em} Destination register of the instruction.\\
    % \vspace{1em}
    % RS1  \hspace{3.34em} Source register 1 of the instruction.\\
    % \vspace{1em}
    % RS2  \hspace{3.34em} Source register 2 of the instruction.\\
    % \end{flushleft}
...
\subsection{I Type}
 %Title of subsubsection
    ...
    % RD  \hspace{3.6em} Destination register of the instruction.\\
    % \vspace{1em}
    % RS1  \hspace{3.34em} Source register of the instruction.\\
    % \vspace{1em}
    % \#imm.  \hspace{1.8em} The immediate value of the instruction, must be capable of being represented\\             \hspace{5.4em} in 16 bits. The syntax to represent a decimal number is as follows:\\
    %         \hspace{5.4em} \#decimal\_number, i.e. \#1 to represent a one. The syntax to represent a\\
    %         \hspace{5.4em} hexadecimal number is as follows: \#0xhexadecimal\_number, i.e. \#0x3F2A \\
...
%END OF ADDI INSTRUCTION
    ...
    % RD  \hspace{3.6em} Destination register of the instruction.\\
    % \vspace{1em}
    % RS1  \hspace{3.85em} Source register of the instruction.\\
    % \vspace{1em}
    % \#imm.  \hspace{1.8em} The immediate value of the instruction, must be capable of being represented\\             \hspace{5.4em} in 16 bits. The syntax to represent a decimal number is as follows:\\
    %         \hspace{5.4em} \#decimal\_number, i.e. \#1 to represent a one. The syntax to represent a\\
    %         \hspace{5.4em} hexadecimal number is as follows: \#0xhexadecimal\_number, i.e. \#0x3F2A \\
